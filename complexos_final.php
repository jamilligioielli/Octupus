			...
			<form class="quest-form " action="">
				<ul>
					...
					<li> <strong style="font-size: 25px;"> Resultado:</strong> <br>
						<p> Você acertou <?php echo $_SESSION['score']; ?> questões de <?php echo $total_questions ?> </p>
					</li>
				</ul>
			</form>
			<?php unset($_SESSION['score']); ?>
			<!-- alterar de acordo com a materia -->
			<a href="./complexos_questmain.php" class="start"><button style="
                  border: none;
                  color: white;
                  padding: 10px 30px;
                  text-align: center;
